...
const translations = {
    en: {
        ...
        'portfolio.project.fuegoBurger': 'Fuego Burger — Burger Web App',
        'portfolio.project.podologia': 'Podiatry — Carolina Méndez',
        'portfolio.project.mariaMarketing': 'María — Digital Marketing Portfolio',
        'portfolio.project.descargador': 'Network Downloader',
        'portfolio.project.serenna': 'Serenna — Wellness Center',
        'portfolio.project.mj': 'M&J — Web Development & Marketing',
        ...
        'portfolio.project.borattiSitio': 'Sanatorio Boratti — Institutional Website',
        'portfolio.project.boratti': 'Patient Portal — Sanatorio Boratti',
    ...
    es: {
        ...
        'portfolio.project.fuegoBurger': 'Fuego Burger — Hamburguesas',
        'portfolio.project.podologia': 'Podología — Carolina Méndez',
        'portfolio.project.mariaMarketing': 'María — Marketing Digital',
        'portfolio.project.descargador': 'Descargador de Redes',
        'portfolio.project.serenna': 'Serenna — Bienestar Corporal',
        'portfolio.project.mj': 'M&J — Desarrollo Web y Marketing',
        ...
        'portfolio.project.borattiSitio': 'Sanatorio Boratti — Sitio institucional',
        'portfolio.project.boratti': 'Portal del Paciente — Sanatorio Boratti',
